...
Partial Public Class UserForms_ScriptRecurrenceForm
    ...
    Protected Overrides Function GetChildControls() As Control()
        ...
        Dim controls_Renamed() As Control = { edtDailyRecurrenceControl, edtWeeklyRecurrenceControl, edtMonthlyRecurrenceControl, edtYearlyRecurrenceControl, edtRecurrenceTypeEdit, edtRecurrenceRangeControl}
